                    ...
                    <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-start">
                        ...
                        <div className="lg:col-span-5 space-y-10">
                            ...
                            <div className="bg-white rounded-[2.5rem] shadow-2xl p-10 border border-gray-100 relative overflow-hidden">
                                ...
                                <a href="tel:+917838212727" className="mt-10 flex items-center justify-center gap-3 w-full py-5 bg-brand-dark text-white rounded-2xl font-bold text-xs uppercase tracking-widest hover:bg-primary-600 transition-all active:scale-95 shadow-xl">
