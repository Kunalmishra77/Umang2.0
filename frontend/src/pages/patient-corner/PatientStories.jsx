    ...
    <div className="bg-white min-h-screen pt-12">
      ...
      <section className="relative min-h-[600px] flex items-center bg-[#0f172a] overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-primary-500/10 rounded-full blur-[120px]" />
        </div>
        <Container className="relative z-10 py-12">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6 leading-tight">
              Healing is a <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-cyan-300 normal">Shared Journey.</span>
            </h1>
            <p className="text-xl text-primary-100 font-light leading-relaxed mb-12 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-6">
              <button onClick={() => document.getElementById('share-story').scrollIntoView({ behavior: 'smooth' })} className="h-14 px-8 rounded-full bg-white text-[#0f172a] font-bold hover:bg-primary-50 transition-all flex items-center gap-2 shadow-xl active:scale-95">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            {[
              ...
              <div key={i} className="group">
                <stat.icon className="w-8 h-8 text-primary-500 mx-auto mb-4 group-hover:scale-110 transition-transform" />
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {categories.map((cat) => (
              <button
                ...
                className={`px-6 py-2.5 rounded-full text-xs font-bold transition-all ${selectedCategory === cat ? 'bg-[#0f172a] text-white shadow-lg' : 'bg-white text-slate-500 border border-slate-200 hover:border-primary-300'}`}
              >
                {cat}
              </button>
            ))}
                  ...
                  <div className="h-64 relative overflow-hidden">
                    ...
                    {story.video && (
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-2xl group-hover:bg-primary-500 group-hover:text-white transition-all duration-300 cursor-pointer">
                          <Play size={24} className="fill-current ml-1" />
                        </div>
                      </div>
                    )}
                    <span className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest text-primary-600">
                      {story.dept}
                    </span>
                  </div>
                  <div className="p-8">
                    <Quote className="w-8 h-8 text-primary-100 mb-4 fill-current" />
                    <p className="text-slate-600 normal mb-8 leading-relaxed font-medium">"{story.quote}"</p>
                    <div className="flex items-center gap-4 pt-6 border-t border-slate-50">
                      <div className="w-10 h-10 rounded-full bg-primary-50 flex items-center justify-center font-bold text-primary-600">{story.name[0]}</div>
                      <div>
          ...
          <div className="bg-white rounded-[3rem] lg:rounded-[4rem] overflow-hidden shadow-premium flex flex-col lg:grid lg:grid-cols-12">
            <div className="lg:col-span-5 h-[300px] lg:h-auto relative overflow-hidden">
              ...
              <div className="absolute bottom-8 left-8 text-white">
                <span className="bg-primary-600 px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest mb-3 inline-block">Highlight</span>
            ...
            <div className="lg:col-span-7 p-10 lg:p-16 flex flex-col justify-center bg-white">
              <span className="text-primary-600 font-black uppercase tracking-[0.2em] text-[10px] mb-4 block">Patient Victory</span>
      ...
      <Section className="bg-white">
        <Container>
          <div className="flex flex-col lg:flex-row justify-between items-end mb-12 gap-6">
            ...
            <Link to="/patient-corner/breakthrough-cases" className="text-primary-600 font-bold text-sm flex items-center gap-2 hover:gap-3 transition-all">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <Link key={i} to={`/patient-corner/patient-stories/${i}`} className="group">
                <div className="p-10 rounded-[3rem] bg-slate-50 border border-slate-100 group-hover:bg-white group-hover:shadow-premium group-hover:border-primary-100 transition-all duration-500 h-full flex flex-col">
                  <span className="text-[10px] font-black uppercase text-primary-500 tracking-[0.2em] mb-6 block">Neurology Recovery</span>
                  ...
                  <div className="flex items-center justify-between pt-8 border-t border-slate-100">
                    ...
                    <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-primary-600 group-hover:text-white transition-all">
                      <ArrowRight size={16} />
                    </div>
                  </div>
                </div>
      ...
      <Section className="bg-[#0f172a] text-white relative overflow-hidden">
        ...
        <Container>
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <span className="text-primary-400 font-bold uppercase tracking-[0.3em] text-[11px] mb-6 block">Support Network</span>
              <h2 className="text-4xl lg:text-6xl font-serif font-bold mb-8">You Are Never <br /><span className="normal text-transparent bg-clip-text bg-gradient-to-r from-primary-300 to-cyan-200">Alone.</span></h2>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-4 group cursor-pointer">
                    <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-primary-400 group-hover:bg-primary-600 group-hover:text-white transition-all">
                      <Users size={20} />
                    </div>
                    <div>
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-12 lg:p-16 rounded-[4rem] text-center">
               <HeartPulse className="w-16 h-16 text-primary-400 mx-auto mb-8 animate-pulse" />
               ...
               <div className="space-y-4">
                  <input type="email" placeholder="Your Email Address" className="w-full h-14 bg-white/5 border border-white/10 rounded-2xl px-6 text-white outline-none focus:ring-2 focus:ring-primary-500 transition-all" />
                  <button className="w-full h-14 bg-primary-600 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-primary-500 shadow-xl shadow-primary-900/20 active:scale-95 transition-all">Register for Meetup</button>
               </div>
            </div>
          </div>
        </Container>
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center group">
                <div className="w-20 h-20 rounded-[2rem] bg-slate-50 flex items-center justify-center text-2xl font-black text-slate-300 mx-auto mb-6 group-hover:bg-primary-50 group-hover:text-primary-600 transition-all duration-500">
                  {s.step}
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 relative">
               ...
               <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-3xl shadow-xl border border-slate-100 hidden md:block">
                  ...
                  <p className="text-[10px] font-black uppercase text-primary-600 mt-2 tracking-widest">- Clinical Director</p>
               </div>
            </div>
          </div>
        </Container>
        ...
        <Container className="relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl text-center md:text-left">
              ...
              <p className="text-primary-100 text-xl font-light">Receive curated recovery stories and health tips from our experts every month.</p>
            </div>
            <div className="flex-1 max-w-md w-full">
               <div className="bg-white/10 backdrop-blur-md p-2 rounded-[2rem] flex items-center border border-white/20">
                  <input type="email" placeholder="Your Email" className="bg-transparent flex-1 px-6 outline-none text-white placeholder-primary-200" />
                  <button className="h-14 w-14 rounded-[1.5rem] bg-white text-primary-600 flex items-center justify-center shadow-xl hover:bg-primary-50 transition-all">
                    <Mail size={24} />
                  </button>
               </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div key={i} className="p-8 rounded-3xl border border-slate-100 hover:border-primary-200 transition-all bg-slate-50/50">
                  <h4 className="font-bold text-brand-dark mb-3 flex items-center gap-3"><HelpCircle className="text-primary-500 w-5 h-5" /> {faq.q}</h4>
      ...
      <section id="share-story" className="py-24 bg-slate-50 overflow-hidden">
         <Container>
            <div className="flex flex-col lg:flex-row gap-20 items-center">
               <div className="lg:w-1/2">
                  <h2 className="text-5xl font-serif font-bold text-brand-dark mb-8 leading-tight">Become a Beacon <br />of <span className="text-primary-600 normal">Hope.</span></h2>
                  ...
                  <form className="bg-white p-10 lg:p-16 rounded-[4rem] shadow-premium relative">
                     <div className="grid md:grid-cols-2 gap-6 mb-6">
                        <div className="space-y-2">
                           ...
                           <input type="text" className="w-full h-14 bg-slate-50 border-none rounded-2xl px-6 text-brand-dark font-bold outline-none focus:ring-2 focus:ring-primary-500/20 transition-all" placeholder="John Doe" />
                        </div>
                        <div className="space-y-2">
                           <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Contact No.</label>
                           <input type="text" className="w-full h-14 bg-slate-50 border-none rounded-2xl px-6 text-brand-dark font-bold outline-none focus:ring-2 focus:ring-primary-500/20 transition-all" placeholder="+91" />
                        </div>
                     </div>
                     <div className="space-y-2 mb-8">
                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Your Victory Story</label>
                        <textarea rows="4" className="w-full bg-slate-50 border-none rounded-2xl p-6 text-brand-dark font-bold outline-none focus:ring-2 focus:ring-primary-500/20 transition-all resize-none" placeholder="How was your experience at Umang Hospital?"></textarea>
                     </div>
                     <button className="w-full h-16 bg-brand-dark text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-primary-600 transition-all shadow-xl active:scale-95">Submit My Story</button>
                  </form>
               </div>
            </div>
         </Container>
      ...
      <Section className="bg-white text-center py-20 border-t border-slate-100">
        <Container>
          <Heart className="w-10 h-10 text-primary-500 mx-auto mb-6 animate-pulse" />
