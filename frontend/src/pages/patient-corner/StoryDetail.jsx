  ...
  return (
    <div className="bg-white min-h-screen pt-16 pb-12">
      ...
      <div className="container-custom max-w-4xl">
        <Link to="/patient-corner/patient-stories" className="inline-flex items-center gap-2 text-gray-500 hover:text-primary-600 mb-8 transition-colors">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="relative rounded-[3rem] overflow-hidden mb-12 shadow-2xl h-[500px]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-12">
              <span className="bg-primary-600 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider mb-4 inline-block w-fit">
                {story.condition}
              </span>
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8 space-y-12">
              <section>
                <Quote className="w-12 h-12 text-primary-100 mb-6 fill-current" />
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-24 space-y-6">
                <div className="bg-primary-50 p-8 rounded-[2rem] border border-primary-100 text-center">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 text-primary-500 shadow-sm">
                  ...
                  <div className="flex justify-center gap-4">
                    <button className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-gray-400 hover:text-primary-500 shadow-sm transition-all"><Share2 className="w-5 h-5" /></button>
                    <button className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-gray-400 hover:text-primary-500 shadow-sm transition-all"><MessageCircle className="w-5 h-5" /></button>
                  </div>
                </div>

                <Link to="/contact" className="block p-8 rounded-[2rem] bg-[#0f172a] text-white text-center group hover:bg-primary-600 transition-all">
                  ...
                  <span className="inline-flex items-center gap-2 font-bold text-primary-400 group-hover:gap-3 transition-all">
