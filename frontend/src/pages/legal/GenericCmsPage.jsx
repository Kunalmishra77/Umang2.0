    ...
    return (
        <div ref={containerRef} className="bg-white min-h-screen font-sans overflow-hidden relative" style={{ position: 'relative' }}>
            ...
            <section className="section-padding bg-white relative">
                ...
                <a href="tel:+917838212727" className="flex items-center gap-4 text-sm font-bold bg-white/10 p-4 rounded-2xl hover:bg-white hover:text-brand-dark transition-all">
                                            <Phone className="w-5 h-5" /> +91 78382 12727
                                        </a>
                                    </div>
                                </div>
                            </div>
