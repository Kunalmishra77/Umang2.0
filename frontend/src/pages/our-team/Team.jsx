...
const Team = () => {
  return (
    <div className="bg-white min-h-screen pt-20">
      <Helmet>
        <title>Our Team - Visionaries of Umang Hospital</title>
            ...
            {heads.slice(0, 4).map((doc, i) => (
              ...
              >
                ...
                <div className="p-6 text-center">
                  ...
                  <Link to={`/doctors/profile/${doc.id}`} className="text-sm font-bold text-gray-400 hover:text-[#005580] flex items-center justify-center gap-1 transition-colors">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            {consultants.map((doc, i) => (
              <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 hover:bg-white hover:shadow-lg transition-all border border-transparent hover:border-gray-100 group">
          ...
          <div className="mt-8 text-center md:hidden">
            <Link to="/doctors" className="btn-outline w-full">View Full Directory</Link>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Our Nursing Team</h2>
