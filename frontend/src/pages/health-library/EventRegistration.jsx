                ...
                <div className="space-y-4">
                   <div>
                      ...
                      <div className="relative">
                         ...
                         <input type="text" required className="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-200 focus:border-primary-500 outline-none" />
                      </div>
                   </div>
                   <div>
                      ...
                      <div className="relative">
                         ...
                         <input type="email" required className="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-200 focus:border-primary-500 outline-none" />
                      </div>
                   </div>
                   <div>
                      ...
                      <div className="relative">
                         ...
                         <input type="tel" required className="w-full h-12 pl-12 pr-4 rounded-xl border border-gray-200 focus:border-primary-500 outline-none" />
                      </div>
                   </div>
                </div>
