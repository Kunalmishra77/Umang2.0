...
const Patients = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <Container className="relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/20 border border-blue-500/30 text-primary-300 text-[10px] font-black uppercase tracking-[0.3em] mb-8">
              ...
              <div className="flex flex-wrap gap-6">
                <Link to="/login" className="px-10 py-5 bg-primary-600 text-white rounded-2xl font-bold text-sm uppercase tracking-widest hover:bg-primary-500 transition-all shadow-xl hover:scale-105 active:scale-95">
                  Access Portal
                </Link>
        ...
        <Container>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={i}>
                <p className="text-3xl font-serif font-bold text-primary-400 mb-1">{stat.value}</p>
      ...
      <Section className="bg-white">
        <Container>
          <SectionHeading 
            ...
            title="Everything You Need, <span class='text-primary-600'>One Login.</span>" 
            ...
            {portalFeatures.map((f, i) => (
              <Link key={i} to={f.path}>
                <Card className="h-full !p-10 border-none bg-slate-50 hover:bg-white hover:shadow-premium transition-all duration-500 group">
                  <div className="w-14 h-14 rounded-2xl bg-white flex items-center justify-center text-primary-600 mb-8 shadow-sm group-hover:bg-primary-600 group-hover:text-white transition-all">
                    <f.icon size={28} />
                  </div>
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-primary-600 flex items-center gap-2">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative order-2 lg:order-1">
               <div className="p-12 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] shadow-2xl relative z-10">
                  <Lock className="w-16 h-16 text-primary-400 mb-8 mx-auto" />
            ...
            <div className="order-1 lg:order-2">
              <span className="text-primary-400 font-bold uppercase tracking-[0.3em] text-[11px] mb-6 block">Your Privacy is Sacred</span>
      ...
      <Section className="bg-white">
        <Container>
          <SectionHeading eyebrow="Getting Started" title="Access Your Health in <span class='text-primary-600'>3 Steps.</span>" centered />
          <div className="grid md:grid-cols-3 gap-12 relative">
            <div className="hidden md:block absolute top-12 left-0 w-full h-0.5 bg-primary-50 -z-0" />
            {[
              ...
              <div key={i} className="text-center relative z-10 group">
                <div className="w-24 h-24 bg-white rounded-full border-4 border-primary-600 flex items-center justify-center text-3xl font-black text-primary-600 mx-auto mb-8 shadow-xl group-hover:bg-primary-600 group-hover:text-white transition-all">
                  {i + 1}
                </div>
        ...
        <Container>
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              ...
              <div className="flex flex-wrap gap-6">
                <button className="px-10 py-5 bg-white text-primary-600 rounded-2xl font-black text-sm uppercase tracking-widest flex items-center gap-3 hover:bg-primary-50 transition-all">
      ...
      <Section className="bg-slate-50">
        <Container>
          <SectionHeading eyebrow="User Feedback" title="What Our Patients <span class='text-primary-600'>Say.</span>" centered />
            ...
            {[
              ...
              <Card key={i} className="!p-12 border-none shadow-sm group hover:shadow-premium transition-all duration-500 bg-white">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-primary-100 flex items-center justify-center font-bold text-primary-600">{t.name[0]}</div>
              ...
              {[
                ...
                <div key={i} className="p-8 rounded-3xl bg-slate-50 border border-slate-100 group hover:border-blue-200 transition-all">
                  <h4 className="text-lg font-bold text-brand-dark mb-4 flex items-center gap-4">
                    <Info className="text-primary-600 w-5 h-5" /> {faq.q}
                  </h4>
        ...
        <Container>
          <div className="bg-brand-dark rounded-[4rem] p-12 lg:p-20 text-white relative overflow-hidden flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-2/3">
              <span className="text-primary-400 font-bold uppercase tracking-widest text-[10px] mb-4 block">System Update v4.2</span>
      ...
      <Section className="bg-[#0f172a] text-white text-center relative overflow-hidden py-24">
        ...
        <Container className="relative z-10">
          <h2 className="text-4xl lg:text-8xl font-serif font-bold mb-10 leading-tight">Ready to <span className="text-primary-400 normal">Log In?</span></h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-8">
            <Link to="/login" className="px-12 py-6 bg-primary-600 text-white rounded-2xl font-bold text-lg hover:bg-primary-700 transition-all shadow-xl hover:scale-105 active:scale-95 flex items-center justify-center gap-4 group">
