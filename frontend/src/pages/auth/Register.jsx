    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row font-sans">
      ...
      <div className="lg:w-5/12 bg-[#0f172a] relative overflow-hidden hidden lg:flex flex-col justify-center p-20 text-white">
         <div className="absolute inset-0 z-0">
            <img src="/UmangLatest/reception1.webp" className="w-full h-full object-cover opacity-20" alt="Hospital" />
         ...
         <div className="relative z-10">
            ...
            >
              Start Your <br /><span className="text-primary-400 normal">Journey to Health.</span>
            </motion.h1>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="space-y-2">
                  ...
                  <div className="relative">
                     ...
                     <input type="text" placeholder="Your full name" className="w-full h-14 pl-12 pr-4 rounded-2xl border border-gray-200 focus:border-primary-500 outline-none" />
                  </div>
               </div>
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                     ...
                     <input type="tel" placeholder="+91 XXXXX XXXXX" className="w-full h-14 pl-12 pr-4 rounded-2xl border border-gray-200 focus:border-primary-500 outline-none" />
                  </div>
               </div>
               ...
               <div className="md:col-span-2 space-y-2">
                  ...
                  <div className="relative">
                     ...
                     <input type="email" placeholder="your@email.com" className="w-full h-14 pl-12 pr-4 rounded-2xl border border-gray-200 focus:border-primary-500 outline-none" />
                  </div>
               </div>
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                     ...
                     <input type="password" placeholder="••••••••" className="w-full h-14 pl-12 pr-4 rounded-2xl border border-gray-200 focus:border-primary-500 outline-none" />
                  </div>
               </div>
               ...
               <div className="md:col-span-2 py-4">
                  <label className="flex items-center gap-3 cursor-pointer group">
                     ...
                     <span className="text-sm text-gray-500 group-hover:text-gray-700 transition-colors">I agree to the <Link to="#" className="text-primary-600 font-bold">Terms & Conditions</Link></span>
                  </label>
               </div>
