    ...
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[320px]">
          ...
          <div className="md:col-span-2 bg-[#0f172a] rounded-[3rem] p-10 relative overflow-hidden group shadow-2xl">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div className="max-w-md">
                <h3 className="text-3xl font-bold text-white mb-4">150-Bedded Superspeciality</h3>
            ...
            <img 
               ...
               className="absolute right-0 bottom-0 w-1/2 h-full object-cover opacity-30 mix-blend-overlay scale-110 group-hover:scale-100 transition-transform duration-1000" 
               alt="Hospital Building"
            />
          </div>

          {/* Card 2: 24/7 Support */}
          <div className="bg-[#f8fafc] rounded-[3rem] p-10 flex flex-col justify-between hover:shadow-xl transition-all duration-500 border border-gray-100 group">
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-md text-red-500 group-hover:bg-red-500 group-hover:text-white transition-all">
               <Clock className="w-7 h-7" />
            </div>
            <div>
               <h3 className="text-2xl font-bold text-[#0f172a] mb-2">24/7 Support</h3>
               <p className="text-gray-500">Emergency trauma care, fully stocked pharmacy, and diagnostic services available round-the-clock.</p>
            </div>
          </div>

          {/* Card 3: Advanced Tech */}
          <div className="bg-[#f8fafc] rounded-[3rem] p-10 flex flex-col justify-between hover:shadow-xl transition-all duration-500 border border-gray-100 group">
            <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-md text-[#005580] group-hover:bg-[#005580] group-hover:text-white transition-all">
               <Zap className="w-7 h-7" />
            </div>
            <div>
               <h3 className="text-2xl font-bold text-[#0f172a] mb-2">Modern Tech</h3>
               <p className="text-gray-500">Cutting-edge Cath Labs, 128 Slice CT, 3 Tesla MRI, and 4D Ultrasound technology.</p>
            </div>
          </div>

          {/* Card 4: Clinical Excellence (Wide) */}
          <div className="md:col-span-2 bg-[#005580] rounded-[3rem] p-10 relative overflow-hidden shadow-2xl group">
             ...
             <div className="relative z-10 flex flex-col md:flex-row items-center h-full gap-8">
                <div className="flex-1">
                   ...
                   <h3 className="text-3xl font-bold text-white mb-4">Clinical Outcomes</h3>
                ...
                <div className="hidden lg:block w-48 h-48 bg-white/5 backdrop-blur-xl rounded-[2.5rem] flex items-center justify-center border border-white/10 shadow-2xl">
